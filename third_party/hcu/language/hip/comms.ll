; ModuleID = 'comms.cpp'
source_filename = "comms.cpp"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-p7:160:256:256:32-p8:128:128-p9:192:256:256:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7:8:9"
target triple = "amdgcn-amd-amdhsa"

@__hip_cuid_ce9c2fe5e8d0c8e5 = addrspace(1) global i8 0
@llvm.compiler.used = appending addrspace(1) global [29 x ptr] [ptr @_Z18load_acquire_agentPU3AS1i, ptr @_Z18load_relaxed_agentPU3AS1i, ptr @_Z19load_acquire_systemPU3AS1i, ptr @_Z19load_relaxed_systemPU3AS1i, ptr @_Z19store_relaxed_agentPU3AS1m, ptr @_Z19store_release_agentPU3AS1m, ptr @_Z20store_relaxed_systemPU3AS1ii, ptr @_Z20store_release_systemPU3AS1ii, ptr @_Z21atom_add_acqrel_agentPU3AS1iS0_, ptr @_Z21red_add_release_agentPU3AS1iS0_, ptr @_Z22atom_add_acqrel_systemPU3AS1ii, ptr @_Z22atom_add_acquire_agentPU3AS1iS0_, ptr @_Z22atom_add_relaxed_agentPU3AS1iS0_, ptr @_Z22load_acquire_workgroupPU3AS1i, ptr @_Z22load_relaxed_workgroupPU3AS1i, ptr @_Z22red_add_release_systemPU3AS1ii, ptr @_Z23atom_add_acquire_systemPU3AS1ii, ptr @_Z23atom_add_relaxed_systemPU3AS1ii, ptr @_Z23store_relaxed_workgroupPU3AS1m, ptr @_Z23store_release_workgroupPU3AS1m, ptr @_Z29atom_cas_acqrel_relaxed_agentPU3AS1iS0_S0_, ptr @_Z30atom_cas_acqrel_relaxed_systemPU3AS1iS0_i, ptr @_Z30atom_cas_acquire_relaxed_agentPU3AS1iS0_S0_, ptr @_Z30atom_cas_relaxed_relaxed_agentPU3AS1iS0_S0_, ptr @_Z30atom_cas_release_relaxed_agentPU3AS1iS0_S0_, ptr @_Z31atom_cas_acquire_relaxed_systemPU3AS1iS0_i, ptr @_Z31atom_cas_relaxed_relaxed_systemPU3AS1iS0_i, ptr @_Z31atom_cas_release_relaxed_systemPU3AS1iS0_i, ptr addrspacecast (ptr addrspace(1) @__hip_cuid_ce9c2fe5e8d0c8e5 to ptr)], section "llvm.metadata"

; Function Attrs: mustprogress nofree norecurse nounwind willreturn memory(argmem: readwrite)
define internal noundef i32 @_Z22load_acquire_workgroupPU3AS1i(ptr addrspace(1) nocapture noundef readonly %0) #0 {
  %2 = load atomic i32, ptr addrspace(1) %0 syncscope("workgroup-one-as") acquire, align 4
  ret i32 %2
}

; Function Attrs: mustprogress nofree norecurse nounwind willreturn memory(argmem: readwrite)
define internal noundef i32 @_Z22load_relaxed_workgroupPU3AS1i(ptr addrspace(1) nocapture noundef readonly %0) #0 {
  %2 = load atomic i32, ptr addrspace(1) %0 syncscope("workgroup-one-as") monotonic, align 4
  ret i32 %2
}

; Function Attrs: mustprogress nofree norecurse nounwind willreturn memory(argmem: readwrite)
define internal noundef i32 @_Z18load_acquire_agentPU3AS1i(ptr addrspace(1) nocapture noundef readonly %0) #0 {
  %2 = load atomic i32, ptr addrspace(1) %0 syncscope("agent-one-as") acquire, align 4
  ret i32 %2
}

; Function Attrs: mustprogress nofree norecurse nounwind willreturn memory(argmem: readwrite)
define internal noundef i32 @_Z18load_relaxed_agentPU3AS1i(ptr addrspace(1) nocapture noundef readonly %0) #0 {
...
define internal noundef i32 @_Z19load_acquire_systemPU3AS1i(ptr addrspace(1) nocapture noundef readonly %0) #0 {
  %2 = load atomic i32, ptr addrspace(1) %0 syncscope("agent") acquire, align 4
  ret i32 %2
}

; Function Attrs: mustprogress nofree norecurse nounwind willreturn memory(argmem: readwrite)
define internal noundef i32 @_Z19load_relaxed_systemPU3AS1i(ptr addrspace(1) nocapture noundef readonly %0) #0 {
  %2 = load atomic i32, ptr addrspace(1) %0 syncscope("agent") monotonic, align 4
  ret i32 %2
}
...
define internal noundef i32 @_Z20store_release_systemPU3AS1ii(ptr addrspace(1) nocapture noundef writeonly %0, i32 noundef returned %1) #0 {
  store atomic i32 %1, ptr addrspace(1) %0 syncscope("agent") release, align 4
  ret i32 %1
}
...
define internal noundef i32 @_Z20store_relaxed_systemPU3AS1ii(ptr addrspace(1) nocapture noundef writeonly %0, i32 noundef returned %1) #0 {
  store atomic i32 %1, ptr addrspace(1) %0 syncscope("agent") monotonic, align 4
  ret i32 %1
}
...
define internal noundef i32 @_Z22red_add_release_systemPU3AS1ii(ptr addrspace(1) nocapture noundef %0, i32 noundef %1) #0 {
  %3 = atomicrmw add ptr addrspace(1) %0, i32 %1 syncscope("agent") release, align 4
  ret i32 %3
}
...
define internal noundef i32 @_Z31atom_cas_acquire_relaxed_systemPU3AS1iS0_i(ptr addrspace(1) nocapture noundef %0, ptr addrspace(1) nocapture noundef %1, i32 noundef %2) #0 {
  ...
  %5 = cmpxchg ptr addrspace(1) %0, i32 %4, i32 %2 syncscope("agent") acquire monotonic, align 4
...
define internal noundef i32 @_Z31atom_cas_release_relaxed_systemPU3AS1iS0_i(ptr addrspace(1) nocapture noundef %0, ptr addrspace(1) nocapture noundef %1, i32 noundef %2) #0 {
  %4 = load i32, ptr addrspace(1) %1, align 4
  %5 = cmpxchg ptr addrspace(1) %0, i32 %4, i32 %2 syncscope("agent") release monotonic, align 4
  %6 = extractvalue { i32, i1 } %5, 1
  br i1 %6, label %9, label %7
...
define internal noundef i32 @_Z31atom_cas_relaxed_relaxed_systemPU3AS1iS0_i(ptr addrspace(1) nocapture noundef %0, ptr addrspace(1) nocapture noundef %1, i32 noundef %2) #0 {
  %4 = load i32, ptr addrspace(1) %1, align 4
  %5 = cmpxchg ptr addrspace(1) %0, i32 %4, i32 %2 syncscope("agent") monotonic monotonic, align 4
  %6 = extractvalue { i32, i1 } %5, 1
  br i1 %6, label %9, label %7
...
define internal noundef i32 @_Z30atom_cas_acqrel_relaxed_systemPU3AS1iS0_i(ptr addrspace(1) nocapture noundef %0, ptr addrspace(1) nocapture noundef %1, i32 noundef %2) #0 {
  %4 = load i32, ptr addrspace(1) %1, align 4
  %5 = cmpxchg ptr addrspace(1) %0, i32 %4, i32 %2 syncscope("agent") acq_rel monotonic, align 4
  %6 = extractvalue { i32, i1 } %5, 1
  br i1 %6, label %9, label %7
...
!4 = !{i32 2, i32 0}
!5 = !{!"AMD clang version 18.0.0git (https://github.com/RadeonOpenCompute/llvm-project roc-6.3.2 25012 e5bf7e55c91490b07c49d8960fa7983d864936c4)"}
!6 = !{!7, !7, i64 0}
!7 = !{!"int", !8, i64 0}

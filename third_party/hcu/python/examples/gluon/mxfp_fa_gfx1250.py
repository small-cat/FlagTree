...
from triton.experimental.gluon.language.hcu.gfx1250 import wmma_scaled
from triton.experimental.gluon.language.hcu.gfx1250 import tdm
from triton.experimental.gluon.language.hcu.gfx1250 import buffer_load, buffer_store
from triton.experimental.gluon.language.hcu.gfx1250 import async_copy as cp
...
class BlockScaledAttentionConfig:
    ...
    def __init__(self, Q_TYPE, KV_TYPE, SEQLEN_Q, SEQLEN_K, NUM_Q_HEADS, NUM_K_HEADS, HEAD_SZ, BLOCK_M, BLOCK_N,
        ...
        self.q_scale_layout = ttgl.constexpr(
            ttgl.hcu.gfx1250.get_wmma_scale_layout(self.q_layout, [self.BLOCK_M, BLOCK_K_SCALE_QK]))
        ...
        self.k_scale_layout = ttgl.constexpr(
            ttgl.hcu.gfx1250.get_wmma_scale_layout(self.k_layout, [self.BLOCK_N, BLOCK_K_SCALE_QK]))
        ...
        self.p_scale_layout = ttgl.constexpr(
            ttgl.hcu.gfx1250.get_wmma_scale_layout(self.p_layout, [self.BLOCK_M, BLOCK_K_SCALE_PV]))
        ...
        self.v_scale_layout = ttgl.constexpr(
            ttgl.hcu.gfx1250.get_wmma_scale_layout(self.v_layout, [self.HEAD_SZ, BLOCK_K_SCALE_PV]))
